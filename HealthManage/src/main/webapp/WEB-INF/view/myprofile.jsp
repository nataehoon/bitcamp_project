...
<div class="container col-sm-12">
	<div class="card card-danger">
		<div class="card-heading" align="center">
			<br><h2 class="font-weight-bold text-danger">내 건강 리스트</h2>
		</div>
		<div class="row card-body">
			...
			<div class="card-body col-sm-4" style="margin-left:10%;background:white">
		...
		<div class="form-group w3-center" style="background-color:white">
			<table>
		  	<c:forEach var="bean" items="${requestScope.llist}">
			  	<c:if test="${i%j == 0}"> 
			  		<tr> 
			  	</c:if> 
				  	<td>
		...
		<div class="form-group w3-center" style="background-color:white">
			<table>
		  	<c:forEach var="bean" items="${requestScope.dlist}">
			  	<c:if test="${i%j == 0}"> 
			  		<tr> 
			  	</c:if> 
				  	<td>
