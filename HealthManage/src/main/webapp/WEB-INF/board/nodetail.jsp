...
<div class="container-fluid col-sm-offset-2 col-sm-8">
	<div class="card shadow mb-4">
					...
					<table class="table table-bordered">
						<tr>
							...
							<td width="90%" align="left">
								${bean.title}<p style="float:right;">글 번호 : ${bean.notino} &nbsp;&nbsp; 작성자 : 관리자 &nbsp;&nbsp;</p>
							</td>
						</tr>
						<tr>
		...
		<div class="col-sm-7" style="float:right;">
			<button class="btn btn-info" onclick="location.href='<%=contextPath%>/noupdate.no?notino=${bean.notino}'">
				글 수정
			</button>
			<button class="btn btn-danger" onclick="location.href='<%=contextPath%>/nodelete.no?notino=${bean.notino}'">
				글 삭제
			</button>
		</div>
	</div>
