...
@Controller
public class LogUpdateController extends SuperClass {
	private final String command = "/update.lo";
	private ModelAndView mav = null;
	private String redirect = "redirect:/logdetail.lo?logno=" ;
	...
	public ModelAndView doPost(
		...
		if(asdf.hasErrors()) {
			...
			String gotopage = this.redirect + xxx.getLogno();
