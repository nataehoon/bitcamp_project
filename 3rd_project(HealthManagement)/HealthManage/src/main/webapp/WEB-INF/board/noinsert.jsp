	...
	<div class="container col-sm-offset-2 col-sm-8">
		<div class="card shadow mb-4">
			<div class="card-header">
				<h4 class="font-weight-bold text-primary">공지사항 등록</h4>
			</div>
			<div class="card-body">
			<c:set var="appath" value="<%=request.getContextPath()%>"/>
			<form:form modelAttribute="notice" id="myform" name="myform" class="form-horizontal" 
				role="form" action="${appath}/noinsert.bo" method="post" enctype="multipart/form-data">
