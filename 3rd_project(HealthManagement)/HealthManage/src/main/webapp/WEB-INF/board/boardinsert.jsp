				...
				<div class="form-group">
				      	...
				      	<div class="col-sm-9">
							<input type="file" class="form-control" name="asdf"
								id="asdf" placeholder="첨부파일" value="default.jpg">
						</div>
				    </div>
