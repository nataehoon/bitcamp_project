...
<div class="container col-sm-12">
	<div class="card">
		<div class="card-heading" align="center">
			<h2 class="font-weight-bold text-danger">건강 데이터 수정</h2>
		</div>	
		<div class="card-body col-offset-3">
			...
			<div class="row form-group">
				...
				<div class="col-sm-2">
					<form:input path="height" type="text" name="height" class="form-control" placeholder="키(신장)" value="${bean.height}${bean.height}"/>
					<form:errors cssClass="err" path="height"/>
				</div>
				<label class="control-label col-sm-2" for="weight">몸무게</label>
				<div class="col-sm-2">
					<form:input path="weight" type="text" name="weight" class="form-control" placeholder="몸무게" value="${bean.weight}${bean.weight}"/>
