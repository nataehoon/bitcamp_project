...
<script type="text/javascript">
	function period(){
		var gu = $('#gu').val();
		location.href='<%=contextPath%>/holist.pl?gu='+gu;
	}
</script>
</head>
<body>
<div class="container col-sm-12">
	...
	<div class="row form-groups" style="background-color:white">
		<c:forEach var="hbean" items="${requestScope.lists}">
		<div class="w3-card col-offset-1 col-sm-3">
			<div class="row cursor" onclick="location.href='<%=contextPath%>/hodetail.pl?hono=${hbean.hono}'">
				<div class="col-sm-3">
					<br>
