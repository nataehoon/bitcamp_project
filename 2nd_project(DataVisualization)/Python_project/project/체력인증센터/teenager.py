...
chartdata.plot(kind='pie', colors=colors, wedgeprops=wedgeprops, legend=False, autopct='%1.2f%%', rot=90, title='상장구분(청소년)', startangle=90)
...
savedfilename = 'getteenagerInfo02.png'
plt.savefig(savedfilename, dpi=400)
print(savedfilename + '파일이 저장됨.')