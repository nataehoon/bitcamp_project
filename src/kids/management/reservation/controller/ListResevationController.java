...
public class ListResevationController extends SuperClass {
	@Override
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String url = contextPath + "/Kids?command=resList" ;
		
		ReservationDao rdao = new ReservationDao();
		
		// 행(row) 총 개수
		int totalCount = rdao.SelectTotalCount(year, month, order, keyword) ; 
		...
		List<Reservation> lists = rdao.selectDataList(
		...
		String gotopage = "/reservation/reList.jsp" ;
